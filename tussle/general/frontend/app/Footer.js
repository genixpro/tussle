...
export function Footer() {
    ...
    return <div className={"footer"}>
        ...
        >
            <Typography sx={{p: 2}}>
                Articulon is a custom tool originally built by Bradley Arsenault for his own blog.<br/>
                To get Articulon at your business, please contact Bradley Arsenault to setup an<br/>
